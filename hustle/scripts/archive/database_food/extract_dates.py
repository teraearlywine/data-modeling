...
query = "SELECT * FROM meals.recipes_db_dates"
local_filename = "files/recipes_dates_extract.csv"
...
source_file_name = parser.get("food_gcp_config", "source_file_name3")
destination_blob_name = parser.get("food_gcp_config", "destination_blob_name3")
